...
table(Idents(data))
data=subset(data,idents=c("Mesenchymal"))
print("Subcluster Mesenchymal")
gc()
...
save(merged.object, file = "/proj/sens2022005/Xenium/PREDIX_HER2/result/cell_typing/Mesenchymal_subcluster.Rdata")  
