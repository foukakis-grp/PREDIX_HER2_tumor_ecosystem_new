...
table(Idents(data))
data=subset(data,idents=c("Epithelial"))
print("Subcluster Epithelial")
gc()
...
save(merged.object, file = "/proj/sens2022005/Xenium/PREDIX_HER2/result/cell_typing/Epithelial_subcluster.Rdata")  
