...
table(Idents(data))
data=subset(data,idents=c("Myeloid","Mast"))
print("Subcluster Myeloid")
gc()
...
save(merged.object,file = "/proj/sens2022005/Xenium/PREDIX_HER2/result/cell_typing/Myeloid_subcluster.Rdata")  
