...
table(Idents(data))
data=subset(data,idents=c("Endothelial"))
print("Subcluster Endothelial")
gc()
...
save(merged.object, silhouette_res, file = "/proj/sens2022005/Xenium/PREDIX_HER2/result/cell_typing/Endothelial_subcluster.Rdata")  
